#include "parse.h"
#include "error.h"
#include "../include/mylib.h" /* gets, strcpy, strlen 등이 여기 있음 */
#include <stdio.h> /* printf는 사용 가능 (mylib에 있거나 헤더에 선언됨) */

Reader YY_reader;

/* [수정 1] ctype.h의 isspace 대신 직접 구현 */
int is_whitespace(char c) {
    return (c == ' ' || c == '\t' || c == '\n' || c == '\r');
}

/* [수정 2] is_delimiter가 내부 is_whitespace를 쓰도록 변경 */
